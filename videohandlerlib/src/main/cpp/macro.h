...
#define LOGI(FORMAT,...) __android_log_print(ANDROID_LOG_INFO,"IMS_FFMPEG",FORMAT,##__VA_ARGS__);
#define LOGE(FORMAT,...) __android_log_print(ANDROID_LOG_ERROR,"IMS_FFMPEG",FORMAT,##__VA_ARGS__);
